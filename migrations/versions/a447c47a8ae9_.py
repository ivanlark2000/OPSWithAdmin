...
Revision ID: a447c47a8ae9
Revises: 
Create Date: 2022-05-23 14:08:52.453601
...
def upgrade():
    ...
    op.create_table('foto_flat',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('url_pic', sa.String(length=200), nullable=False),
